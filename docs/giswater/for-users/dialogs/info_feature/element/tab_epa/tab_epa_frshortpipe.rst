...
The feature frshortpipe, has the following data:
...
.. raw:: html
	<details>
		<summary>Tabla Shortpipe: tbl_inp_shortpipe - None</summary>
		<ul>
			<li>**Tipo de dato:** None.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** No.</li>
			<li>
				<details class='no-square'>
					...
					<ul>
						<li>saveValue (False): Hola</li>
						<li>tableUpsert (ve_inp_dscenario_frshortpipe): Hola</li>
					</ul>
				</details>
			</li>
		</ul>
...
.. raw:: html
	<details>
		<summary>Min Uheadloss:: headloss_min - Max uheadloss</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** No.</li>
