...
The feature frpump, has the following data:

.. raw:: html
	<details>
		<summary>Tabla Pump: tbl_inp_pump - None</summary>
		<ul>
			...
			<li>
				<details class='no-square'>
					...
					<ul>
						...
						<li>tableUpsert (ve_inp_dscenario_pump): Hola</li>
					</ul>
				</details>
			</li>
		</ul>
...
.. raw:: html
	<details>
		...
		<ul>
			...
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** Sí.</li>
			<li>**Valores:** Los valores de este desplegable estan determinados por la consulta: SELECT id, id AS idval FROM inp_curve WHERE id IS NOT NULL AND curve_type IN ('PUMP', 'PUMP1', 'PUMP2', 'PUMP3', 'PUMP4').</li>
			<li>
				<details class='no-square'>
					<summary><b>Controles:</b> Controles del campo</summary>
					<ul>
...
.. raw:: html
	<details>
		<summary>Price Pattern:: energy_pattern_id - Price pattern</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** Sí.</li>
			<li>**Valores:** Los valores de este desplegable estan determinados por la consulta: SELECT pattern_id as id, pattern_id as idval FROM ve_inp_pattern WHERE pattern_id is not null.</li>
			<li>
				<details class='no-square'>
					<summary><b>Controles:</b> Controles del campo</summary>
					<ul>
...
.. raw:: html
	<details>
		<summary>Eff. Curve:: effic_curve_id - Eff. curve</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** Sí.</li>
			<li>**Valores:** Los valores de este desplegable estan determinados por la consulta: SELECT id as id, id as idval FROM ve_inp_curve WHERE curve_type = 'EFFICIENCY'.</li>
		</ul>
	</details>
