...
.. raw:: html
	...
	<details>
		<summary><strong>Tipo De Orificio:</strong> ori_type - Orientación del orificio: LATERAL o INFERIOR.</summary>
		<ul>
...
.. raw:: html
	...
	<details>
		<summary><strong>Cd:</strong> cd - Coeficiente de descarga (sin unidades).</summary>
		<ul>
			<li><strong>Datatype:</strong> Double.</li>
			<li><strong>Mandatory:</strong> No.</li>
			<li><strong>Editable:</strong> Sí.</li>
...
.. raw:: html
	...
	<details>
		<summary><strong>Orate:</strong> orate - Tiempo en horas decimales para abrir un orificio completamente cerrado (o cerrar uno completamente abierto). Utilice 0 si el orificio puede abrirse/cerrarse instantáneamente.</summary>
		<ul>
			<li><strong>Datatype:</strong> Double.</li>
			<li><strong>Mandatory:</strong> No.</li>
			<li><strong>Editable:</strong> Sí.</li>
...
.. raw:: html
	...
	<details>
		<summary><strong>Forma:</strong> shape - Las únicas formas permitidas son CIRCULAR y RECT_CLOSED (rectangular cerrada).</summary>
		<ul>
			<li><strong>Datatype:</strong> String.</li>
			<li><strong>Mandatory:</strong> No.</li>
			<li><strong>Editable:</strong> Sí.</li>
...
.. raw:: html
	...
	<details>
		<summary><strong>Geometría 1:</strong> geom1 - Profundidad máxima (pies o m).</summary>
		<ul>
			<li><strong>Datatype:</strong> Double.</li>
			<li><strong>Mandatory:</strong> No.</li>
			<li><strong>Editable:</strong> Sí.</li>
...
.. raw:: html
	...
	<details>
		<summary><strong>Tiempo De Cierre:</strong> close_time - Hora de cierre</summary>
		<ul>
