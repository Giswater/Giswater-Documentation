	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> The values of this dropdown are determined by the query:
				<code>
					SELECT id, id as idval FROM cat_element WHERE element_type = 'EOUTLET'
				</code>
			</li>
			<li>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> The values of this dropdown are determined by the query:
				<code>
					SELECT function_type as id, function_type as idval FROM man_type_function WHERE 'ELEMENT'=ANY(feature_type) OR 'EOUTLET' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> The values of this dropdown are determined by the query:
				<code>
					SELECT category_type as id, category_type as idval FROM man_type_category WHERE 'ELEMENT'=ANY(feature_type) OR 'EOUTLET' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> The values of this dropdown are determined by the query:
				<code>
					SELECT location_type as id, location_type as idval FROM man_type_location WHERE 'ELEMENT'=ANY(feature_type) OR 'EOUTLET' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> The values of this dropdown are determined by the query:
				<code>
					SELECT id, id as idval FROM cat_brand WHERE 'EOUTLET' = ANY(featurecat_id::text[])
				</code>
			</li>
		</ul>
	</details>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> The values of this dropdown are determined by the query:
				<code>
					SELECT id, id as idval FROM cat_brand_model WHERE 'EOUTLET' = ANY(featurecat_id::text[])
				</code>
			</li>
		</ul>
	</details>
		...
		<ul>
			...
			<li>
				<details class='no-square'>
					<summary><strong>Widgetcontrols:</strong> Field controls</summary>
					<ul>
						<li><strong>setMultiline</strong> (True): Sets the possibility of multiline fields for writing with enter</li>
					</ul>
				</details>
			</li>
		</ul>
