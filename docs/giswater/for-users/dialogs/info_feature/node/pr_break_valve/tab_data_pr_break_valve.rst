...
========================
Pr_Break_Valve: Tab Data
========================

The feature pr_break_valve, has the following data:
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> Los valores de este desplegable estan determinados por la consulta:
				<code>
					SELECT id, id as idval FROM cat_brand WHERE 'PR_BREAK_VALVE' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> Los valores de este desplegable estan determinados por la consulta:
				<code>
					SELECT id, id as idval FROM cat_brand_model WHERE 'PR_BREAK_VALVE' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
