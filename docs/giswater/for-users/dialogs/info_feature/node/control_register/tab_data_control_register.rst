.. _tab-data-control_register

==========================
Control_Register: Tab Data
==========================

The feature control_register, has the following data:
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> Los valores de este desplegable estan determinados por la consulta:
				<code>
					SELECT function_type as id, function_type as idval FROM man_type_function WHERE ((featurecat_id is null AND feature_type='NODE') ) AND active IS TRUE  OR 'CONTROL_REGISTER' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> Los valores de este desplegable estan determinados por la consulta:
				<code>
					SELECT category_type as id, category_type as idval FROM man_type_category WHERE ((featurecat_id is null AND feature_type='NODE')) AND active IS TRUE  OR 'CONTROL_REGISTER' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> Los valores de este desplegable estan determinados por la consulta:
				<code>
					SELECT fluid_type as id, fluid_type as idval FROM man_type_fluid WHERE ((featurecat_id is null AND feature_type='NODE') ) AND active IS TRUE  OR 'CONTROL_REGISTER' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> Los valores de este desplegable estan determinados por la consulta:
				<code>
					SELECT location_type as id, location_type as idval FROM man_type_location WHERE ((featurecat_id is null AND feature_type='NODE') ) AND active IS TRUE  OR 'CONTROL_REGISTER' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> Los valores de este desplegable estan determinados por la consulta:
				<code>
					SELECT id, id as idval FROM cat_brand WHERE 'CONTROL_REGISTER' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
...
.. raw:: html
	...
	<details>
		...
		<ul>
			...
			<li><strong>Dvquerytext:</strong> Los valores de este desplegable estan determinados por la consulta:
				<code>
					SELECT id, id as idval FROM cat_brand_model WHERE 'CONTROL_REGISTER' = ANY(featurecat_id::text[])
				</code>
			</li>
			<li>
				<details class='no-square'>
