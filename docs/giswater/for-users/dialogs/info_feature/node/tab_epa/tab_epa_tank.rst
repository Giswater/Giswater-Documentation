...
.. raw:: html
	<details>
		<summary>Init Level:: initlevel - Initial level</summary>
		<ul>
...
.. raw:: html
	<details>
		<summary>Tabla Tank: tbl_inp_tank - None</summary>
		<ul>
			<li>**Tipo de dato:** None.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** No.</li>
			<li>
				<details class='no-square'>
					...
					<ul>
						<li>saveValue (False): Hola</li>
						<li>tableUpsert (ve_inp_dscenario_tank): Hola</li>
					</ul>
				</details>
			</li>
		</ul>
...
.. raw:: html
	<details>
		<summary>Min Level:: minlevel - Minimum level</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** Sí.</li>
...
.. raw:: html
	<details>
		<summary>Max Level:: maxlevel - Maximum level</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** Sí.</li>
...
.. raw:: html
	<details>
		<summary>Min Volume:: minvol - Minimum volume</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** Sí.</li>
...
.. raw:: html
	<details>
		<summary>Overflow:: overflow - Overflow</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** Sí.</li>
...
.. raw:: html
	<details>
		<summary>Avg Head:: headavg - Avg demand</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** No.</li>
...
.. raw:: html
	<details>
		<summary>Mixing Model:: mixing_model - Mixing model</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** Sí.</li>
			<li>**Valores:** Los valores de este desplegable estan determinados por la consulta: SELECT id, idval FROM inp_typevalue WHERE typevalue='inp_value_mixing'.</li>
			<li>
				<details class='no-square'>
					<summary><b>Controles:</b> Controles del campo</summary>
					<ul>
...
.. raw:: html
	<details>
		<summary>Mixing Fraction:: mixing_fraction - Mixing fraction</summary>
		<ul>
			<li>**Tipo de dato:** string.</li>
			<li>**Obligatorio:** No.</li>
			<li>**Editable:** Sí.</li>
