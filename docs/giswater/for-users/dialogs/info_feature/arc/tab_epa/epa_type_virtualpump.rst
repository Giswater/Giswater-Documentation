...
.. raw:: html
	...
	<p class='layout-header'>The widgets in the layout lyt_epa_1 are:</p>
...
.. raw:: html
	...
	<details>
		<summary><strong>Energy Pattern:</strong> energy_pattern_id - Energy pattern</summary>
		<ul>
			<li><strong>Datatype:</strong> String.</li>
			<li><strong>Mandatory:</strong> No.</li>
			<li><strong>Editable:</strong> Sí.</li>
...
.. raw:: html
	...
	<details>
		<summary><strong>Tabla Virtualpump:</strong> tbl_inp_virtualpump - None</summary>
		<ul>
			<li><strong>Datatype:</strong> Unknown.</li>
			<li><strong>Mandatory:</strong> No.</li>
			<li><strong>Editable:</strong> No.</li>
			<li>
				<details class='no-square'>
					...
					<ul>
						<li><strong>saveValue</strong> (False): </li>
						<li><strong>tableUpsert</strong> (ve_inp_dscenario_virtualpump): </li>
					</ul>
				</details>
			</li>
		</ul>
