...
The feature pipelink, has the following data:
...
.. raw:: html
	...
	<details>
		<summary><strong>Connecat Id:</strong> conneccat_id - connecat_id - A seleccionar del catálogo de acometida. Es independiente del tipo de acometida</summary>
		<ul>
			<li><strong>Datatype:</strong> String.</li>
			<li><strong>Mandatory:</strong> No.</li>
			<li><strong>Editable:</strong> No.</li>
...
.. raw:: html
	...
	<details>
		<summary><strong>Sector Id:</strong> sector_id - sector_id  - Sector identifier.</summary>
		<ul>
			<li><strong>Datatype:</strong> Integer.</li>
			<li><strong>Mandatory:</strong> No.</li>
			<li><strong>Editable:</strong> No.</li>
