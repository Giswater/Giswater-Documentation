...
**herramientas y procesos para analizar y exportar datos.** Permite **representar** la información y geometría de nuestra red **en el plano.**
 ...
 1. Descarga del Software 
   .. figure:: img-instalacion-puesta-marcha/descarga_QGIS_1.png
   ...
   aparecen en la página de inicio **“Descargar”**.
    ...
    .. figure:: img-instalacion-puesta-marcha/descarga_QGIS_2.png

  .. attention::  Vamos a descargar la versión estable de QGIS 
    que se llama QGIS 3.40 :guilabel:`LTR`. 

.. figure:: img-instalacion-puesta-marcha/descarga_QGIS_3.png

  Si no tenes Windows, podes elegir la versión que mejor se adapte a tu 
sistema operativo: 

  .. figure:: img-instalacion-puesta-marcha/descarga_QGIS_4.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_QGIS_5.png
...
El archivo descargado se guarda de la siguiente manera: 
 ...
 .. figure:: img-instalacion-puesta-marcha/descarga_QGIS_6.png

  **En Linux**
La página tiene una guía de instalación para seguir paso a paso:

.. figure:: img-instalacion-puesta-marcha/descarga_QGIS_7.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_QGIS_8.png

  * Se abre el instalador, damos clic en Siguiente 
.. figure:: img-instalacion-puesta-marcha/descarga_QGIS_9.png

  * Aceptamos los términos de licencia: 
  .. figure:: img-instalacion-puesta-marcha/descarga_QGIS_10.png

  * Elegimos la carpeta de destino (recomendamos dejarlo por defecto):
  .. figure:: img-instalacion-puesta-marcha/descarga_QGIS_11.png

  * Inicia la instalación del programa. Puede tardar unos 10 a 20 minutos 
dependiendo de la PC
 .. figure:: img-instalacion-puesta-marcha/descarga_QGIS_12.png
...
La descarga de PostgreSQL se puede realizar desde `Aqui https://www.postgresql.org https://www.postgresql.org`_.
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_3.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_4.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_5.png
...
* Aparecerá el asistente de instalación. Haz clic en Siguiente.
 .. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_6.png

* Selecciona el destino de instalación (recomendamos dejarlo por defecto). 
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_7.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_8.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_9.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_10.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_11.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_12.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_13.png
...
.. figure:: img-instalacion-puesta-marcha/descarga_PostgreSQL_14.png
...
La descarga e instalación de **DBeaver** es un proceso sencillo. Puedes realizarlo accediendo a su sitio web oficial desde `Aquí <https://dbeaver.io/download/> `_ . 
...
* Por último, decidimos si queremos crear un acceso directo en el escritorio y hacemos clic en "Terminar".
  ...
  .. figure:: img-instalacion-puesta-marcha/DBeaver_12.png
