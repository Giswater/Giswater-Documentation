...
project = 'Giswater Documentation'
copyright = '2025, Giswater'
author = 'Giswater Authors'
...
html_theme_options = {
    ...
    'canonical_url': 'https://docs.giswater.org/latest/es_CR/',
...
html_context = {
    # When a Giswater version reaches end of life, set this to True to show an information
    # message on the top of the page.
    'outdated': False,
    # When a new Giswater version is released, set this to False to remove the disclaimer
